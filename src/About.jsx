...
function About(){
    return(
        <section id="about" className="grid grid-cols-[1fr_max-content] max-xl:flex max-xl:flex-col-reverse px-32 max-xl:px-16 max-sm:px-4 mt-64 max-sm:mt-32 w-full max-w-[2400px] justify-self-center gap-8 max-xl:gap-16">
